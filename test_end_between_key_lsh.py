...
DB_INFO = {'host':'127.0.0.1','port':3306,'DB':'YJ_TEST','TB':'test0520'}
folder = 'F:/Study/510/DocYJ/DataBase/Test20190520/'
mat_file = 'tensornew.mat'
...
class LSHAnalysis():
    ...
    def Mainfunc(self,mat_addr,result_folder,binary_file,key):
        ...
        #core 只针对DIR
        imodel_name = 'sqlite_x86_o1'
        imodel_BIN_name = 'sqlite_x86_o1'
        ...
        itest_name = 'sqlite_x86_o2'
        itest_BIN_name = 'sqlite_x86_o2'
    ...
    #    output_total = open(result_folder + 'result_total.txt', 'w')
        ...
        Inmodel_NUM = 0.0
        output = open(result_folder + 'KeyBetweenByLSH' + '.txt', 'a')
